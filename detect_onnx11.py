...
# https://github.com/SihabSahariar/Yolov11-ONNX-Object-Detection/tree/main
...
model_path = "runs/detect/train16/weights/best.onnx"
...
class YOLODetector:
    def __init__(self, model_path=model_path, conf_thresh=0.5, iou_thresh=0.45):
